...
const passwordResetLimiter = rateLimit({
    ...
    message: {
        success: false,
        error: 'TOO_MANY_REQUESTS',
        message: 'Demasiadas solicitudes de reseteo de contraseña, por favor intente de nuevo más tarde.'
    }
});
...
router.post('/resend-verification', authLimiter, validateEmail, resendVerificationCode);
router.post('/verify', authLimiter, validateVerification, verifyRegistration);
router.post('/login', authLimiter, validateLogin, login);

// Rutas de reseteo de contraseña con un limiter más estricto
router.post('/request-password-reset', passwordResetLimiter, validateEmail, requestPasswordReset);
router.post('/verify-reset-code', passwordResetLimiter, validateVerification, verifyResetCode);
